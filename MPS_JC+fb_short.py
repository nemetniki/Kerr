...
if args.cohC>0:
	...
	filename = "./Data/JC+fb/New/evol%04d_atom_drive_A.txt" % (args.ID)
	outname = "./Data/JC+fb/New/OUT%04d_atom_drive_A.txt" % (args.ID)
	specname = "./Data/JC+fb/New/spec%04d_atom_drive_A.txt" % (args.ID)
	g2tau = "./Data/JC+fb/New/g2tau%04d_atom_drive_A.txt" % (args.ID)
	corrf = "./Data/JC+fb/New/corr%04d_atom_drive_A.txt" % (args.ID)
	Bdenspath = "./Data/JC+fb/New/Bdens%04d_atom_drive_A" % (args.ID)
	Cdenspath = "./Data/JC+fb/New/Cdens%04d_atom_drive_A" % (args.ID)
elif Omc>0:
