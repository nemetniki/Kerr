...
#    print("M =",M)
    ...
    U_block = U(states[ind_sys+1],states[ind_sys],states[ind_sys-1],M)
...
plt.grid(True)
plt.figure(figsize = (12,7))
plt.plot(t,gr_pop,lw=3,label="ground",color=colors["orange"])
